		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnatraining03zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining03zhoui5-display": {
								"semanticObject": "atclouddnatraining03zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training03.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/training03/zhoui5")
								}
							}
						}
					}
